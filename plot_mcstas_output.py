...
InstrReader = reader.McStas_file(os.path.join(path_to_model, result_folder, "V20_config6.instr"))
...
x, y = np.genfromtxt(os.path.join(path_to_model, result_folder,  selected_filename),
